...
const crypto = require('crypto'); // usaremos nesse contexto para criar uma id aleatória de uma ong
...
module.exports = {
    async create(request, response) {
        ...
        const id = crypto.randomBytes(4).toString('HEX'); // nosso id será igual a 4 bytes de caracteres aleatórios convertidos para HEXADECIMAL
